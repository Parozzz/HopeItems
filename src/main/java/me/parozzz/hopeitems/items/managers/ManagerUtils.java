...
public class ManagerUtils 
{
    ...
    {
        Location l = new Location(Bukkit.getWorld(map.getValue("world")), Integer.valueOf(map.getValue("x")), Integer.valueOf(map.getValue("y")), Integer.valueOf(map.getValue("z")));
