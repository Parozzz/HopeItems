...
public class HeadUtils 
{
    ...
    public static String getMHFOwner(final EntityType et) 
    {
        return "MHF_"+et.name().substring(0,1).toUpperCase()+et.name().substring(1).toLowerCase().replace("_", ""); 
    }
    
    public static ItemStack createHead(final String url)
    {
        ItemStack item = new ItemStack(Material.SKULL_ITEM, 1, (short)3);
        return addTexture(item, url);
    }
    ...
    public static ItemStack addTexture(final ItemStack item, final String url)
    {
        ...
        {
            Logger.getLogger(HeadUtils.class.getName()).log(Level.SEVERE, null, ex);
        }
